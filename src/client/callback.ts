 ...
 */
export function getCallbackParams(search: string | URLSearchParams): CallbackParams {
 ...
 */
export function getCallbackRedirectUri(config: { authServerBaseUrl: string; appBaseUrl?: string; callbackPath?: string }): string {
